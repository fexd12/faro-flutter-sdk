...
public class FaroPlugin: NSObject, FlutterPlugin {
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        let didBecomeActiveNotification: Notification.Name
        ...
        NotificationCenter.default.addObserver(
            instance, selector: #selector(applicationDidBecomeActive),
            name: didBecomeActiveNotification, object: nil)
    ...
    @objc private func applicationDidBecomeActive() {
        ...
        let currentTimeMilliseconds =
            Double(Int64(time.tv_sec) * 1000) + Double(time.tv_usec) / 1000.0
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        case "enableCrashReporter":
            do {
                let crashReporter = try CrashReportingIntegration(
                    crashReporterConfig: call.arguments as! [String: Any])
            } catch {
